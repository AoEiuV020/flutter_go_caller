...
# Run `pod lib lint flutter_go_caller.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_go_caller'
  s.version          = '0.0.1'
...
A new Flutter FFI plugin project.
  ...
  # s.resource_bundles = {'flutter_go_caller_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
